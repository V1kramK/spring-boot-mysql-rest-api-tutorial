...
// Import Get_ApiMCPTool - included in same package
// Import GetMCPTool - included in same package
// Import Get_NotesMCPTool - included in same package
// Import Put_Notes_IdMCPTool - included in same package
// Import Delete_Notes_IdMCPTool - included in same package
// Import Post_NotesMCPTool - included in same package
// Import Get_Notes_IdMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Get_ApiMCPTool.createGet_ApiTool(config),
            GetMCPTool.createGetTool(config),
            Get_NotesMCPTool.createGet_NotesTool(config),
            Put_Notes_IdMCPTool.createPut_Notes_IdTool(config),
            Delete_Notes_IdMCPTool.createDelete_Notes_IdTool(config),
            Post_NotesMCPTool.createPost_NotesTool(config),
            Get_Notes_IdMCPTool.createGet_Notes_IdTool(config)
            );
